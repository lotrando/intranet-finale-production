              ...
              <div class="list-group-item">
                <div class="row align-items-center">
                  ...
                  <div class="col text-truncate">
                    <a class="text-primary d-block text-decoration-none" href="{{ route('soubory.'. $item->category->category_type.'.download', $item->id) }}" target="_blank">
                  ...
                  <div class="col-auto">
                    ...
                    @endif
                    <span class="text-muted description">{{ Carbon\Carbon::parse($item->updated_at)->format('d. m. Y') }}</span>
