...
@section('content')
  ...
  <div class="container-fluid">
                    ...
                    <div class="col text-truncate" id="{{ $document->id }}">
                      ...
                      <div class="d-block description text-muted text-truncate">
                        <span class="text-{{ $document->category->color }}">{{ ucfirst($document->category->button) }} >
                          {{ Str::upper($document->category->category_type) }}</span> - {{ $document->description }}
                      </div>
                    </div>
                  </div>
                </div>
    ...
    <div class="hr-text text-blue m-3">{{ __('přílohy') }}</div>
    {{-- addons --}}
    <div class="mb-1">
                ...
                <div class="list-group-item border-0 p-0">
                  <div class="row align-items-center g-3 mx-1">
                    <div class="avatar bg-{{ $addon->category->color }}-lt col-auto" data-bs-toggle="tooltip" data-bs-placement="top"
                      data-bs-original-title="{{ $addon->category->folder_name }} dokumentace">
                    ...
                    <div class="col-auto">
                      <a href="{{ route('soubory.dokument.addon.download', $addon->id) }}" target="_blank">
                    ...
                    <div class="col text-truncate" id="{{ $addon->id }}">
                      <span>
                        <p class="show d-inline text-primary text-decoration-none cursor-pointer" id="{{ $addon->id }}" data-bs-toggle="tooltip"
                          data-bs-placement="top" data-bs-original-title="Více informací o dokumentu {{ $addon->description }}" style="margin-bottom: 0;">
                          {{ $addon->description }}
                        </p>
                      </span>
                      <div class="d-block description text-muted text-truncate">
                        <span class="text-{{ $addon->category->color }}">{{ ucfirst($addon->category->button) }} >
                          {{ Str::upper($addon->category->category_type) }}</span> - {{ $addon->description }}
                      </div>
                    </div>
                  </div>
                </div>
