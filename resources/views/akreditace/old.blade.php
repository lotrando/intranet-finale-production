    ...
    <div class="container-fluid">
      ...
      <div class="row g-1 d-flex justify-content-center">
        ...
        <div class="col-2 col-md-auto">
          <a class="btn bg-{{ $category->color }}-lt hover-shadow-sm w-100" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="{{ __('' . $category->category_name . '') }}" href="/{{ $category->category_file }}/{{ $category->folder_name . '/' . $category->id }}">
      ...
      <div class="row align-items-center mx-1 mt-1">
        ...
        <div class="ms-auto d-print-none col-auto">
          <div class="btn-list">
            ...
            @auth
            <button class="btn btn-lime d-inline-block me-2" id="openCreateModal" data-bs-toggle="tooltip" data-bs-placement="left" data-bs-original-title="{{ __('Vytvoří nový ' . $categorie->category_type . '') }}">
              <svg class="icon icon-inline" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                  ...
                  <div class="list-group list-group-flush list-group-hoverable py-2">
                    <div class="list-group-item border-0 p-0">
                      <div class="row align-items-center g-3 mx-1">
                        ...
                        <div class="col text-truncate" id="{{ $document->id }}">
                          <span>
                            <p class="show d-inline text-primary text-decoration-none cursor-pointer" id="{{ $document->id }}" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Více informací o dokumentu {{ $document->description }}" style="margin-bottom: 0;">
                              @if ($categorie->id != 3)
                              {{ $i++ . '.' }}
                              @endif
                              {{ $document->name }}
                        ...
                        <div class="col-auto">
                          <span class="btn btn-icon hover-shadow cursor-pointer" data-bs-toggle="dropdown">
                            <svg class="icon dropdown-item-icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                          ...
                          <ul class="dropdown-menu">
                            <li class="dropdown-item edit" id="{{ $document->id }}">
                              <svg class="icon dropdown-item-icon-edit" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                            ...
                            <li class="dropdown-item addon" id="{{ $document->id }}">
                              <svg class="icon dropdown-item-icon-addon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                            ...
                            <li class="dropdown-item delete" id="{{ $document->id }}'" disabled>
                              <svg class="icon dropdown-item-icon-delete" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                                <path d="M4 7h16"></path>
                    ...
                    <div class="list-group-item py-1 px-1">
                      <div class="row d-flex justify-content-between">
                        <div class="col-auto">
                          <svg class="icon text-yellow" width="24" height="24" viewBox="0 0 24 24" stroke-width="1" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                  ...
                  <div class="row align-items-center g-3 mx-1 mb-1">
                    ...
                    <div class="col-auto">
                      <a href="/soubory/{{ $document->category->category_type }}/priloha/{{ $add->id }}">
                        <span class="avatar bg-{{ $document->category->color }}-lt" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Stáhnout soubor .{{ substr($add->file, strpos($add->file, '.') + 1) }}">
                    ...
                    <div class="col text-truncate" id="{{ $add->id }}">
                      <span>
                        <p class="show-addon d-inline text-primary text-decoration-none cursor-pointer" id="{{ $add->id }}" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Více informací o příloze {{ $add->description }}" style="margin-bottom: 0;">
                          {{ $add->description }}
                        </p>
                      </span>
                      <div class="d-block description text-muted text-truncate">
                        {{ $add->document->name }} - Příloha č.{{ $add->position }}
                        <svg class="icon icon-tabler icon-tabler-certificate-2 text-yellow" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                          <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                    ...
                    <div class="col-auto">
                      ...
                      <ul class="dropdown-menu">
                        ...
                        <li class="dropdown-item add-delete" id="{{ $add->id }}">
                          <svg class="icon icon dropdown-item-icon-delete" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none">
                            </path>
                            <path d="M4 7h16"></path>
                            <path d="M5 7l1 12a2 2 0 0 0 2 2h8a2 2 0 0 0 2 -2l1 -12">
    ...
    <div class="modal-footer">
      ...
      <div class="align-content-end flex">
        <button class="btn btn-primary ms-auto hover-shadow" id="action_button" name="action_button" type="submit">
          <svg class="icon icon-tabler icon-tabler-book-upload" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
            <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
  ...
  <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
    <div class="modal-content shadow-lg">
      ...
      <div class="modal-body py-4 text-center">
        <svg class="icon text-danger icon-lg mb-3" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
          <path stroke="none" d="M0 0h24v24H0z" fill="none" />
...
$('.addon').click(function() {
  ...
  $('#add_user_id').val('{{ auth()->user()->id ?? null }}')
  $('#add_user_name').val('{{ auth()->user()->name ?? '
    Guest ' }}')
  $('#add_revision').val('')
