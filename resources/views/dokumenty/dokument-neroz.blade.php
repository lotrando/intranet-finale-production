                        ...
                        <div class="list-group-item border-0 p-0">
                          <div class="row align-items-center g-3 mx-1">
                            ...
                            <div class="col-auto">
                              ...
                              @elseif($document->accordion_name == 0)
                                <img src="{{ asset('img/files/link.png') }}" alt="SKLAD" height="32px">
                              @endif
                              </span>
                              </a>
                            </div>
                              ...
                              <span>
                                <p class="@if (substr($document->file, strpos($document->file, '.') + 1) == 'pdf') show text-primary cursor-pointer @else text-azure text-decoration-none @endif mb-0 block"
                                  ...
                                  <span data-bs-toggle="tooltip" data-bs-placement="top"
                                    ...
                                    @if (substr($document->file, strpos($document->file, '.') + 1) == 'pdf') Náhled souboru @else Náhled souboru Office nebo odkazu není možný @endif"
                            ...
                            <div class="col text-truncate">
                              ...
                              <div class="d-block description text-muted text-truncate">Tento dokument je předtišten a je k
                                dispozici u paní Čiernikové Marcely email: <a href="mailto:ciernikova@khn.cz">ciernikova@khn.cz</a> mob: <span
                                  class="text-azure fw-bold">602459731</span> klapka: <span class="text-azure fw-bold">114</span>
                              </div>
                            </div>
                          </div>
                        </div>
      ...
      <div class="modal-content shadow-lg">
        ...
        <form id="skladInputForm" action="{{ route('documents.sklad') }}">
          ...
          <div class="modal-body">
            ...
            <div class="row">
              <div class="col-2 mb-2">
                <label class="form-label">{{ __('Typ linku') }}</label>
                <select class="form-control" id="type_link" name="type" type="text" placeholder="{{ __('Externí nebo interní link') }}">
