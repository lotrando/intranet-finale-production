...
{{--                   <div class="avatar bg-{{ $notification->importance ?? 'muted' }}-lt mx-1">
          ...
          @endforeach
          <div class="hr-text text-orange py-2">Dlouhodobě plánované akce a sdělení</div>
        ...
        {{-- <div class="col-12 col-xl-2 order-2">
          ...
          <div class="mb-3">
            <div class="d-flex justify-content-center text-muted">
              <div>
                <a href="https://www.hc-institute.org/cz/dotazniky/zamestnanci-nemocnic.html" target="_blank">
                  <img class="shadow-sm" src="{{ asset('img/hci_logo.png') }}" alt="HCI Logo">
                </a>
              </div>
            </div>
          </div>
