                    ...
                    <div class="row d-flex align-items-center justify-content-between">
                      ...
                      @auth
                        <div class="col-12 col-lg-4">
                          <div class="text-blue"> {{ $day->nutricni_terapeuti }}</div>
                          <div class="text-azure">{{ $day->nutricni_mobile }}</div>
                        </div>
                        <div class="col-12 col-lg-5">
                          <select class="form-select edit" name="nutricni-terapeuti[{{ $day->id }}]" data-id="{{ $day->id }}">
                            <option value="">Změnit terapeuta</option>
                            @foreach ($nutricni as $doctor)
                              <option value="{{ $doctor->title_preffix . ' ' . $doctor->last_name . ' ' . $doctor->first_name }}"
                                @if (old('nutricni-terapeuti[' . $day->id . ']') == $doctor->title_preffix . ' ' . $doctor->last_name . ' ' . $doctor->first_name) selected @endif data-mobile="{{ $doctor->mobile }}">
                      ...
                      @else
                        <div class="col-7 d-flex align-items-center justify-content-start">
                          <div class="text-truncate fw-bold">{{ $day->nutricni_terapeuti }}</div>
                          <div class="text-azure">{{ $day->nutricni_mobile }}</div>
                        </div>
                      @endauth
                    </div>
  ...
  <script>
    $('.edit').on('change', function() {
      ...
      $.ajax({
        ...
        url: "/sluzby/nutricni/update/" + id,
        data: {
          nutricni_mobile: mobile,
          nutricni_terapeuti: value,
          id: id
        },
        dataType: "json",
