                    ...
                    <div class="row d-flex align-items-center justify-content-between">
                      ...
                      @auth
                        <div class="col-12 col-lg-4">
                          <div class="text-blue"> {{ $day->rdg }}</div>
                          <div class="text-azure">{{ $day->rdg_mobile }}</div>
                        </div>
                        <div class="col-12 col-lg-5">
                          <select class="form-select edit" name="rdg[{{ $day->id }}]" data-id="{{ $day->id }}">
                            <option value="">Změnit lékaře</option>
                            @foreach ($doctorsRdg as $doctor)
                              <option value="{{ $doctor->title_preffix . ' ' . $doctor->last_name }}" @if (old('rdg[' . $day->id . ']') == $doctor->title_preffix . ' ' . $doctor->last_name) selected @endif
                      ...
                      @else
                        <div class="col-7 d-flex align-items-center justify-content-start">
                          <div class="text-truncate fw-bold">{{ $day->rdg }}</div>
                          <div class="text-azure">{{ $day->rdg_mobile }}</div>
                        </div>
                      @endauth
                    </div>
