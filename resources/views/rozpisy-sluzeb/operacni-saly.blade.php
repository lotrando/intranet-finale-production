                        ...
                        @auth
                          <div class="col-12 col-lg-3">
                            <select class="form-select edit-a" name="os_a[{{ $day->id }}]" data-id="{{ $day->id }}">
                              <option value="">Změnit sestru</option>
                ...
                <div id="printarea">
                  <div class="card" style="height: 48rem">
                    ...
                    <div class="card-body card-body-scrollable card-body-scrollable-shadow p-1">
                          ...
                          <tbody>
                            @foreach ($daylist as $day)
                              <tr>
                                ...
                                <td class="py-0">{{ $day->os_a }}</td>
                                <td class="py-0">{{ $day->os_b }}</td>
                                <td class="py-0">{{ $day->os_c }}</td>
                                <td class="py-0"></td>
                              </tr>
                            @endforeach
                          </tbody>
                      ...
                      <div class="hr-text">Vytisknuto: {{ \Carbon\Carbon::now()->format('d. m. Y') }}</div>
                    </div>
                  </div>
                </div>
              </div>
